...
func (c *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	...
	crParentTeamSlug := slug.Make(ptr.Deref(cr.Spec.ForProvider.Parent, ""))
	ghParentTeamSlug := ""
	if t.Parent != nil {
	...
	if crParentTeamSlug != ghParentTeamSlug ||
		ptr.Deref(cr.Spec.ForProvider.Privacy, "secret") != *t.Privacy ||
...
func (c *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	...
	name := meta.GetExternalName(cr)
	teamSlug := slug.Make(name)
	privacy := ptr.Deref(cr.Spec.ForProvider.Privacy, "secret")
